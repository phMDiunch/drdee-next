// src/features/dashboard/components/DashboardTodayServices.tsx
"use client";
...
export const DashboardTodayServices = () => {
  const {
    data: todayServices = [],
    isLoading: loading,
    error,
  ...
  if (error) {
    return (
      <Card title="🦷 Dịch vụ tư vấn hôm nay">
